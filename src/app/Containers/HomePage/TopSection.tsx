...
const TopSection = () => {
    return (
        <TopSecContainer>
            <LeftContainer>
                <Slogo>
                    Build <SpanContainer> your skill</SpanContainer> to the next <SpanContainer>  level. </SpanContainer> 
                </Slogo>
                <Description>
                    Expend your free time to build a prfessional career with our instractor. Choice your time to spend and engaige with your favorite  course. 
                </Description>
                <ButtonContainer>
                    <Button text="Buy Now"/>
                    <Button theme='Filled' text="Cources"/>
                </ButtonContainer>
